...
public class Main {
    ...
    private static void channelController() {
        ...
        while (run) {
            ...
            System.out.println("3: 채널 이름 수정");
            System.out.println("4: 채널 정보 삭제");
    ...
    private static void messageController() {
        ...
        while (run) {
            ...
            System.out.println("2: 모든 메시지 조회");
    ...
    private static void userController() {
        ...
        while (run) {
            ...
            System.out.println("2: 모든 사용자 정보 조회");
            System.out.println("3: 사용자 이름 수정");
